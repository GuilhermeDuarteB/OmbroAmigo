        ...
        <ul>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <li class="user-dropdown">
                    <a
                        href="<?= ($_SESSION['user_type'] == 'UtilizadorProfissional') ? '../../dashboardProfissionais/dashboardInicial/index.php' : '../../dashboard/dashinicial/index.php'; ?>">
                        <img src="<?= !empty($_SESSION['user_photo']) ? 'data:image/jpeg;base64,' . $_SESSION['user_photo'] : '../../dashboard/conta/uploads/defaultPhoto.png'; ?>"
                            class="user-photo" alt="Foto do usuário">
                    </a>
                    <div class="user-dropdown-menu">
                        <ul>
                            <li><a
                                    href="<?= ($_SESSION['user_type'] == 'UtilizadorProfissional') ? '../../dashboardProfissionais/dashboardInicial/index.php' : '../../dashboard/dashinicial/index.php'; ?>">Dashboard</a>
                            </li>
