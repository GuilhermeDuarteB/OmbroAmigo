...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['pfp']) && $_FILES['pfp']['error'] === UPLOAD_ERR_OK) {
        ...
        if (in_array($fileType, $allowedMimeTypes)) {
            ...
            $updateFotoQuery = "UPDATE UtilizadoresProfissionais SET Foto = :foto WHERE Id = :Id";
    ...
    $updateQuery = "UPDATE UtilizadoresProfissionais SET Nome = :nome, DataNascimento = :dataNascimento, Telefone = :telefone WHERE Id = :Id";
...
$query = "SELECT NomeUtilizador, Nome, DataNascimento, Telefone, Foto FROM UtilizadoresProfissionais WHERE Id = :Id";
...
if ($utilizador) {
    ...
    $fotoSrc = "uploads/defaultPhoto.png"; // Imagem padrão se o utilizador não for encontrado
}
...
<body>
        ...
        <div class="info">
            ...
            <!-- Menu Inserir Foto -->
            <div class="pfpMenu" id="pfpMenu" style="display: none;">
                ...
                <form action="upload.php" method="POST" enctype="multipart/form-data" id="uploadForm">
                    <div class="filebox" id="filebox">
                        ...
                        <input type="file" id="fileInput" name="pfp" accept="image/*" required>
                    </div>
